  ...
  <Card>
    ...
    <CardContent className="space-y-4">
      <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg text-xs text-blue-700 dark:text-blue-400">
        AI Disclaimer: This plan is generated by AI based on your logged data. Always consult a qualified coach before making significant changes to your training. CrewSync is not responsible for injuries resulting from AI-generated recommendations.
      </div>
      {!isProfileComplete && (
