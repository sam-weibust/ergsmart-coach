...
// ── Hardcoded seed regattas (updated each year) ──────────────────────────────
const SEED_REGATTAS = [
  // ── 2026 upcoming ──────────────────────────────────────────────────────────
  { crewtimer_id: "seed-bah-2026",    name: "Brentwood Aquatic Invitational",          event_date: "2026-04-25", end_date: "2026-04-26", location: "Redwood City, CA",       host_club: "Brentwood Rowing Club",            event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-sraa-2026",   name: "SRAA National Championship 2026",         event_date: "2026-05-01", end_date: "2026-05-03", location: "Sarasota, FL",           host_club: "Scholastic Rowing Assoc",          event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-stobt-2026",  name: "Stotesbury Cup Regatta 2026",             event_date: "2026-05-08", end_date: "2026-05-09", location: "Philadelphia, PA",       host_club: "Schuylkill Navy",                  event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-dadv-2026",   name: "Dad Vail Regatta 2026",                   event_date: "2026-05-08", end_date: "2026-05-09", location: "Philadelphia, PA",       host_club: "Dad Vail Regatta Committee",       event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-nera-2026",   name: "New England Rowing Championships 2026",   event_date: "2026-05-16", end_date: "2026-05-17", location: "Worcester, MA",          host_club: "WPI Rowing",                       event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-mwrc-2026",   name: "Midwest Rowing Championship 2026",        event_date: "2026-05-22", end_date: "2026-05-24", location: "Indianapolis, IN",       host_club: "White River Rowing Club",          event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-acra-2026",   name: "ACRA National Championship 2026",         event_date: "2026-05-31", end_date: "2026-06-02", location: "Oak Ridge, TN",          host_club: "ACRA",                             event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-ira-2026",    name: "IRA National Championship 2026",          event_date: "2026-06-04", end_date: "2026-06-06", location: "Camden, NJ",             host_club: "Intercollegiate Rowing Assoc",     event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-usra-2026",   name: "USRowing Senior National Championship",   event_date: "2026-06-29", end_date: "2026-07-05", location: "Oklahoma City, OK",      host_club: "USRowing",                         event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-wcra-2026",   name: "Western Canadian Rowing Championship",    event_date: "2026-07-11", end_date: "2026-07-12", location: "Burnaby, BC",            host_club: "BC Rowing",                        event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-usrn-2026",   name: "USRowing Youth National Championship",    event_date: "2026-07-27", end_date: "2026-08-01", location: "Sarasota, FL",           host_club: "USRowing",                         event_type: "sprint",    status: "upcoming"  },
  { crewtimer_id: "seed-hopo-2026",   name: "Head of the Ohio 2026",                   event_date: "2026-10-03", end_date: "2026-10-04", location: "Pittsburgh, PA",         host_club: "Three Rivers Rowing Association",  event_type: "head_race", status: "upcoming"  },
  { crewtimer_id: "seed-hotf-2026",   name: "Head of the Fish 2026",                   event_date: "2026-10-10", end_date: "2026-10-11", location: "Saratoga Springs, NY",   host_club: "Saratoga Rowing Association",       event_type: "head_race", status: "upcoming"  },
  { crewtimer_id: "seed-hotc-2026",   name: "Head of the Charles Regatta 2026",        event_date: "2026-10-17", end_date: "2026-10-18", location: "Boston, MA",             host_club: "Cambridge Boat Club",              event_type: "head_race", status: "upcoming"  },
  { crewtimer_id: "seed-hosc-2026",   name: "Head of the Schuylkill 2026",             event_date: "2026-10-24", end_date: "2026-10-25", location: "Philadelphia, PA",       host_club: "Schuylkill Navy",                  event_type: "head_race", status: "upcoming"  },
  { crewtimer_id: "seed-hooh-2026",   name: "Head of the Hooch 2026",                  event_date: "2026-11-07", end_date: "2026-11-08", location: "Chattanooga, TN",        host_club: "Chattanooga Rowing Center",         event_type: "head_race", status: "upcoming"  },
  // ── 2026 completed ─────────────────────────────────────────────────────────
  { crewtimer_id: "seed-crash-2026",  name: "CRASH-B Sprints 2026",                    event_date: "2026-02-22", end_date: "2026-02-22", location: "Boston, MA",             host_club: "Cambridge Boat Club",              event_type: "sprint",    status: "completed" },
  { crewtimer_id: "seed-knecht-2026", name: "Knecht Cup Regatta 2026",                 event_date: "2026-03-28", end_date: "2026-03-29", location: "San Diego, CA",          host_club: "San Diego Rowing Club",            event_type: "sprint",    status: "completed" },
  { crewtimer_id: "seed-sdcc-2026",   name: "San Diego Crew Classic 2026",             event_date: "2026-04-04", end_date: "2026-04-05", location: "San Diego, CA",          host_club: "San Diego Crew Classic",           event_type: "sprint",    status: "completed" },
  // ── 2025 completed ─────────────────────────────────────────────────────────
  ...
  { crewtimer_id: "seed-usrn-2025",   name: "USRowing Youth National Championship",    event_date: "2025-07-28", end_date: "2025-08-02", location: "Sarasota, FL",           host_club: "USRowing",                         event_type: "sprint",    status: "completed" },
  ...
  { crewtimer_id: "seed-wcra-2025",   name: "Western Canadian Rowing Championship",    event_date: "2025-07-12", end_date: "2025-07-13", location: "Burnaby, BC",            host_club: "BC Rowing",                        event_type: "sprint",    status: "completed" },
];
