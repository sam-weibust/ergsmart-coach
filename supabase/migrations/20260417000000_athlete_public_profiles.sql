...
-- RPC to safely increment profile view count
...
-- RPC to increment coach view count
...
AS $$
  UPDATE athlete_profiles
  SET coach_view_count = COALESCE(coach_view_count, 0) + 1
  WHERE user_id = target_user_id AND is_public = true;
$$;

-- Pre-populate rowing coaches directory
